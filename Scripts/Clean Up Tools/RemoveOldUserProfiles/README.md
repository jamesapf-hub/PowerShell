...
* **Hybrid & Azure AD / Entra ID Support:** Detects both traditional on-prem AD profiles (`S-1-5-21-*`) and pure Azure AD profiles (`S-1-12-1-*`).
...
> [!NOTE]
> **Log File Location:** `$env:SystemDrive\Logs\RemoveOldUserProfiles\RemoveOldUserProfiles_DDMMYY.log` (Output dynamically written to console and file)
